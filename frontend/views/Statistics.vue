<template>
	<div>
		<heatmap :entries="weekdays" subtitle="Popularność wybranych dni tygodnia" title="Podsumowanie tygodniowe"></heatmap>
		<hr class="mb-6">
		<heatmap :entries="months" subtitle="Popularność wybranych miesięcy" title="Podsumowanie miesięczne"></heatmap>
		<hr class="mb-6">
		<compass :extremes="extremes" v-if="extremes"></compass>
	</div>
</template>
